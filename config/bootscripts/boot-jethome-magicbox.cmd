...
echo "Set fdtfile to magicbox"
env set fdtfile "amlogic/meson-axg-jethome-cma-magicbox.dtb"
env set board jethome-magicbox
env set board_name jethome-magicbox
...
if test "${console}" = "serial"; then setenv consoleargs "console=ttyAML0,115200n8 console=ttyAML2,115200n8"; fi
